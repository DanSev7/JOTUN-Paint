...
const KPICard = ({ title, value, change, changeType, icon, gradient }) => {
  return (
    <div className="group relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
