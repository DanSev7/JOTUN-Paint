...
import { UserPlus, User, Lock, ArrowRight, Shield, Eye, UserCheck } from 'lucide-react';
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // First, check if the username already exists in our profiles table
      ...
      // Insert new user directly into the user_profiles table
